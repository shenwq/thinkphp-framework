...
namespace ffhome\framework\traits;
...
trait JumpTrait
{
     ...
     */
    protected function successPage($count, $list)
    {
        $data = [
     ...
     */
    protected function success($msg = '', $data = '', $url = null, $wait = 1)
    {
     ...
     * @throws HttpResponseException
     */
    protected function error($msg = '', $data = '', $url = null, $wait = 3)
    {
        if (is_null($url)) {
